...
num_basis_heads="4"
num_graphs="4 6"
echo "=== 시나리오 2 VQVAE Additional FGW: 'Heart_disease_statlog', 'Cardiovascular_Disease_Dataset', 'heart_target_3', 'heart_target_4' -> heart_target_2 ==="
for random_seed in $random_seeds; do
    for n_graphs in $num_graphs; do
        for few_shot in $few_shots; do
            base_dir="test20251106_MultiSource_VQVAE_Additional_FGW_Target_heart_target_2"
            ...
            CUDA_VISIBLE_DEVICES=$gpu_id OMP_NUM_THREADS=10 python main_S.py \
                ...
                --diversifying_loss \
                --additional_FGW \
                --des MultiSource_VQVAE_Additional_FGW_diversifying_loss20251106_heart_target_2_${n_graphs}
        done
    done
done
