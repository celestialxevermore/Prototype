...
def _balance_kw(args, is_binary):
    """클래스 불균형 보정 — LogReg/RF 의 class_weight='balanced' 에 대응.
    CatBoost 는 auto_class_weights='Balanced' 가 같은 역할을 한다."""
