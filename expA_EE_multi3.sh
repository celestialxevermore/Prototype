#!/bin/bash
# ================================================================================
# Exp A — Case 2 누락분 (alpha=0.80 seed 48,50 + alpha=0.90 seed 42,44)
# 2026.04.07
# ================================================================================
gpu_id=3
base_dir="expA_EE_20260406"
...
run_one() {
    ...
    CUDA_VISIBLE_DEVICES=$gpu_id OMP_NUM_THREADS=10 python main_EE.py \
        --exp_mode case2 \
...
echo "=== [Case 2] 누락분 alpha=0.8 (seed 48,50), alpha=0.9 (seed 42,44) ==="
run_one 0.8 48
run_one 0.8 50
run_one 0.9 42
run_one 0.9 44
