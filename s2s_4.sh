...
#         echo "Running experiment for $source_dataset with $shot few-shot samples in random_seed:1234"
...
# 3000부터 3199까지 200개의 랜덤 시드로 반복
for random_seed in $(seq 3000 3199); do
    for few_shot in $few_shots; do 
        for source_dataset in $source_datasets; do
