...
num_basis_heads="1"
num_graphs="4 6"
echo "=== 시나리오 2 VQVAE_Additional_FGW: 'Heart_disease_statlog', 'Cardiovascular_Disease_Dataset', 'heart_target_3', 'heart_target_4' -> heart_target_1 ==="
for random_seed in $random_seeds; do
    for n_graphs in $num_graphs; do
        for few_shot in $few_shots; do
            base_dir="test20251106_MultiSource_VQVAE_Target_heart_target_1"
            ...
            CUDA_VISIBLE_DEVICES=$gpu_id OMP_NUM_THREADS=10 python main_S.py \
                ...
                --des MultiSource_VQVAE_20251106_heart_target_1
        done
    done
done
