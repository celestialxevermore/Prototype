...
num_basis_heads="1"
num_graphs="4 6"
echo "=== 시나리오 1 VQVAE: 'Heart_disease_statlog', 'Cardiovascular_Disease_Dataset', 'heart_target_3', 'heart_target_4' -> heart_target_1 ==="
    ...
    for n_graphs in $num_graphs; do
        for few_shot in $few_shots; do
            ...
            CUDA_VISIBLE_DEVICES=$gpu_id OMP_NUM_THREADS=10 python main_S.py \
                ...
                --additional_FGW \
                --des MultiSource_VQVAE_Additional_FGW_20251106_heart_target_1
        done
    done
done
