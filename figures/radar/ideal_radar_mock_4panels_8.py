"""Ideal radar mock v8 — overall scale reduced to match real radar outputs.

v7 problem: polygons too large/bold compared to actual analysis2.py outputs.
v8 fix:
- Spike heights: 1.4-1.5 → 1.0-1.1
- Mid-range fill: 0.4-0.7 → 0.1-0.3
- Negative spikes: -1.4 → -1.2
- All structural features (containment, sudden drops, B5 differentiation) preserved.
- TN ref unchanged.
"""
import numpy as np
...
# ============================================================
# v8 — scaled-down to match real analysis2.py output magnitudes.
# ============================================================
sources = [
    ...
    ('Cardiovascular', 'Cardiovascular_Disease_Dataset',
     ...
     [
        ...
        # B5 Cardio: outward oldpeak peak + mild maxHR notch
    ...
    ('heart', 'heart',
     ...
     [
        ...
        # B5 Heart: outward chol bump + deep inward maxHR drop (asymmetric, distinct from Cardio B5)
...
render('/home/eungyeop/LLM/tabular/ProtoLLM_entropic20251217/figures/ideal_radar_mock_4panels_8_with.png',
       show_neff=True)
render('/home/eungyeop/LLM/tabular/ProtoLLM_entropic20251217/figures/ideal_radar_mock_4panels_8_no.png',
       show_neff=False)
