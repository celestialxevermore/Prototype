"""Ideal radar mock v9 — same as v8 but Heart_disease_statlog panel removed (6 panels)."""
import numpy as np
...
def render(out_path_base, show_neff):
    M = len(sources)
...
render('/home/eungyeop/LLM/tabular/ProtoLLM_entropic20251217/figures/radar/ideal_radar_mock_4panels_9_with',
       show_neff=True)
render('/home/eungyeop/LLM/tabular/ProtoLLM_entropic20251217/figures/radar/ideal_radar_mock_4panels_9_no',
       show_neff=False)
