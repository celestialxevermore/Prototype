...
echo "=== 시나리오 1: heart_target_1 heart_target_2 heart_target_3 heart_target_4 -> heart (diversifying_loss on/off) ==="

for random_seed in $random_seeds; do
    for few_shot in $few_shots; do
        # Case 2: diversifying_loss ON
        base_dir="test20251101_divloss_OFF"
        ...
        CUDA_VISIBLE_DEVICES=$gpu_id OMP_NUM_THREADS=10 python main_S.py \
            ...
            --des No_USE_Diversifying_Loss_SingleSource
