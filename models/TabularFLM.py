...
#             # 중간 layer 추가로 feature correlation 학습 강화
...
#             self.layer_norms = nn.LayerNorm(self.input_dim).to(self.device)
#             self.dropouts = nn.Dropout(self.args.aggr_attn_dropout_rate).to(self.device)
