...
#from torch_geometric.nn import topk

from torch_scatter import scatter_add
from torch_scatter import scatter
from torch_geometric.utils import degree
from utils.util import zeros, glorot, hyperedge_representation
...
class HyperedgePool(MessagePassing):
    ...
    def forward(self, x, batch, edge_index, edge_weight):
        ...
        score = score.view(-1)
        perm = torch.topk(score, self.ratio, batch)
...
class ReadoutModule(torch.nn.Module):
    def __init__(self, args):
        ...
        # 128, 128) 128
        self.nhid = 128
        self.weight = torch.nn.Parameter(torch.Tensor(128, 128))
        nn.init.xavier_uniform_(self.weight.data)
...
class MLPModule(torch.nn.Module):
    def __init__(self, args):
        ...
        self.lin0 = torch.nn.Linear(128 * 2 * 4, 128 * 2)
