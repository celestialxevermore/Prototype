#!/bin/bash
# ================================================================================
# Exp A — Single-Source Baseline (alpha 0.6 ~ 1.0)
# 2026.04.02
# ================================================================================
gpu_id=5
random_seeds="42 44 46 48 50"
sampling_alphas="0.6 0.7 0.8 0.9 1.0"
...
echo "=== [Exp A] Single-Source Baseline (alpha 0.6~1.0) ==="
...
echo "=== [Exp A] Single-Source Baseline (alpha 0.6~1.0) 완료 ==="
