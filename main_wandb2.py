...
sweep_config = {
    ...
    'parameters': {
        ...
        'attn_type': {'values': ['gat_v2']},  # gat_v1은 따로 실행
...
def train():
    ...
    cmd = [
        ...
        '--use_wandb',
        '--wandb_project', 'tabular-hyperparams-sweep-gat_v2'
    ]
...
if __name__ == "__main__":
    # Sweep 생성
    sweep_id = wandb.sweep(sweep_config, project="tabular-hyperparams-sweep-gat_v2")
    print(f"Sweep created: {sweep_id}")
    print(f"View at: https://wandb.ai/your-entity/tabular-hyperparams-sweep-gat_v2/sweeps/{sweep_id}")
